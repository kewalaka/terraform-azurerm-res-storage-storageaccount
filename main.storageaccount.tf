...
resource "azurerm_storage_account_customer_managed_key" "this" {
  ...
  lifecycle {
    precondition {
      condition     = var.managed_identities != null && length(var.managed_identities.user_assigned_resource_ids) > 0 && (var.storage_account_account_kind == "StorageV2" || var.storage_account_account_tier == "Premium")
